...
output_folder = "../"*string(wt_name)*"/neutral/"
...
file_msa = output_folder*string(wt_name)*"_neutral_samples"*string(Nseqs)*"_T"*string(temp)* "_mu$(mu)_mubind$(mu_bind)_pairs$(Npairs).fa"
file_en = output_folder*"en_"*string(wt_name)*"_neutral_samples"*string(Nseqs)*"_T"*string(temp)* "_mu$(mu)_mubind$(mu_bind)_pairs$(Npairs).txt"
file_ham = output_folder*"ham_"*string(wt_name)*"_neutral_samples"*string(Nseqs)*"_T"*string(temp)* "_mu$(mu)_mubind$(mu_bind)_pairs$(Npairs).txt"
file_pair_ham = output_folder*"pair_ham_" *string(wt_name)*"_neutral_samples"*string(Nseqs)*"_T"*string(temp)* "_mu$(mu)_mubind$(mu_bind)_pairs$(Npairs).txt"
